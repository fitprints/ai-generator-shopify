...
export default function Home() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'Arial' }}>
      ...
      />
      <button onClick={generateImage} style={{ marginLeft: '10px', padding: '10px' }}>Generate</button>
      {loading && <p>{message}</p>}
      {image && (
        <div>
          <h3>Preview:</h3>
          ...
          <br />
          <button onClick={addToShopify} style={{ marginTop: '1rem', padding: '10px' }}>Add to Store</button>
        </div>
      )}
